...
namespace XboxDownload
{
    public partial class Form1 : Form
    {
        ...
        bool bFirstTips = true;
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.WindowState = FormWindowState.Minimized;
            this.Hide();
            if (bFirstTips && !bStartup)
            {
                bFirstTips = false;
        ...
        private void DgvIpList_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            switch (host)
            {
                ...
                case "xvcf2.xboxlive.com":
                    ...
                    tsmUseIPPS.Visible = tsmUseIPEaBattle.Visible = tsmUseIPNS.Visible = tsmUseIPEpic.Visible = false;
                    break;
                ...
                case "ares.dl.playstation.net":
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPEaBattle.Visible = tsmUseIPNS.Visible = tsmUseIPEpic.Visible = false;
                    tsmUseIPPS.Visible = true;
                    break;
                case "origin-a.akamaihd.net":
                case "blzddist1-a.akamaihd.net":
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPPS.Visible = tsmUseIPEpic.Visible = false;
                    tsmUseIPEaBattle.Visible = tsmUseIPNS.Visible = true;
                    break;
                case "epicgames-download1-1251447533.file.myqcloud.com":
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPPS.Visible = tsmUseIPEaBattle.Visible = tsmUseIPNS.Visible = false;
                    tsmUseIPEpic.Visible = true;
                    break;
                default:
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPPS.Visible = tsmUseIPEaBattle.Visible = tsmUseIPNS.Visible = tsmUseIPEpic.Visible = false;
                    break;
            }
